...
import { Delete } from '@chat/controllers/delete-chat-mesage';
...
class ChatRoutes {
  ...
  public routes(): Router {
    ...
    this.router.post('/chat/message/remove-chat-users', authMiddleware.checkAuthentication, Delete.prototype.markMessageAsDeleted);
